...
import {HarvesterEntitySystem, HarvesterComponent} from "../src/system.harvester";
...
{
    private harvester: HarvesterEntitySystem;
    ...
    public setup()
    {
        ...
        this.harvester = new HarvesterEntitySystem(this.world);
    }
    ...
    public test1(env: MyStuff)
    {
        ...
        this.harvester.processEntity(bot);
